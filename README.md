# BadgerDB [![GoDoc](https://godoc.org/github.com/czsilence/badger?status.svg)](https://godoc.org/github.com/czsilence/badger) [![Go Report Card](https://goreportcard.com/badge/github.com/czsilence/badger)](https://goreportcard.com/report/github.com/czsilence/badger) [![Build Status](https://teamcity.dgraph.io/guestAuth/app/rest/builds/buildType:(id:Badger_UnitTests)/statusIcon.svg)](https://teamcity.dgraph.io/viewLog.html?buildTypeId=Badger_UnitTests&buildId=lastFinished&guest=1) ![Appveyor](https://ci.appveyor.com/api/projects/status/github/czsilence/badger?branch=master&svg=true) [![Coverage Status](https://coveralls.io/repos/github/czsilence/badger/badge.svg?branch=master)](https://coveralls.io/github/czsilence/badger?branch=master)
...
[Changelog]:https://github.com/czsilence/badger/blob/master/CHANGELOG.md
...
[v1.0.1]: //github.com/czsilence/badger/tree/v1.0.1
[v0.8.1]: //github.com/czsilence/badger/tree/v0.8.1
[v0.9.0]: //github.com/czsilence/badger/tree/v0.9.0
...
```sh
$ go get github.com/czsilence/badger/...
```
...
[metrics]: https://github.com/czsilence/badger/blob/master/y/metrics.go
...
[badger-bench]: https://github.com/czsilence/badger-bench

## Other Projects Using Badger
Below is a list of known projects that use Badger:

* [0-stor](https://github.com/zero-os/0-stor) - Single device object store.
* [Dgraph](https://github.com/czsilence/dgraph) - Distributed graph database.
...
Please see Github issues [#293](https://github.com/czsilence/badger/issues/293)
and [#315](https://github.com/czsilence/badger/issues/315).
...
- Please use [Github issue tracker](https://github.com/czsilence/badger/issues) for filing bugs or feature requests.
